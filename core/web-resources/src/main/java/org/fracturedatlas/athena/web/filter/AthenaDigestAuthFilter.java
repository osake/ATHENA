...
/**
 * A client filter to enable Athena Components to talk to each other using Digest authorization
 *
 * The source code is almost entirely copied from Raphael Jolivet's HTTPDigestAuthFilter located in the jersey-client
 * sub-project of the Jersey project.  I would rather have extended HTTPDigestAuthFilter, but it is marked as final
 *
 * The code has been modified to accept a hashed password as opposed to a username
 * and password.  This is because Athena components do not have access to the user's user and password at runtime.
 *
 * @author gary.moore@fracturedatlas.org
 */
public class AthenaDigestAuthFilter extends ClientFilter {
     ...
     * @param pass
     */
    public AthenaDigestAuthFilter (String user, String ha1) {
        this.user = user;
        this.ha1 = ha1;
    }
