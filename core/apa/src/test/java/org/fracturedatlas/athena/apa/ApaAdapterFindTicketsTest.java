...
//    }
    ...
    public void testFindMultipleTickets3() {
        ...
        HashMap<String, Ticket> seedTickets = new HashMap<String, Ticket>();
        ...
        seedTickets.put(IdAdapter.toString(t.getId()), t);
        seedTickets.put(IdAdapter.toString(t2.getId()), t2);
        seedTickets.put(IdAdapter.toString(t3.getId()), t3);
        seedTickets.put(IdAdapter.toString(t4.getId()), t4);
        seedTickets.put(IdAdapter.toString(t5.getId()), t5);
        seedTickets.put(IdAdapter.toString(t6.getId()), t6);
        ...
        for (Ticket ticket : tickets) {
            String id = IdAdapter.toString(ticket.getType());
            if (idsFound.contains(id)) {
                fail("Found the same ticket twice");
            } else {
                idsFound.add(id);
            }
            Ticket originalTicket = seedTickets.get(id);
            assertTrue(originalTicket.equals(ticket));
        }
    }
//
//    /*
