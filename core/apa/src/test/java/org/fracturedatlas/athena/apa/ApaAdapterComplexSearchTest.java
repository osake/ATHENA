...
public class ApaAdapterComplexSearchTest extends BaseApaAdapterTest {
    ...
    @Test
    public void testFindTicketsDateNotAssigned() {
        addPropField(ValueType.DATETIME, "LOCK_EXPIRES", StrictType.NOT_STRICT);
        addRecord("ticket",
                  "LOCK_EXPIRES", "2011-06-06T10:10:20Z");
        addRecord("ticket",
                  "LOCK_EXPIRES", "2011-06-01T10:10:20Z");
        addRecord("ticket");
        
        AthenaSearch search = new AthenaSearch.Builder()
                .type("ticket")
                .and("LOCK_EXPIRES", Operator.LESS_THAN, "2011-07-01T01:01:01Z")
                .build();
