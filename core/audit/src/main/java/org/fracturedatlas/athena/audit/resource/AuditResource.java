...
public class AuditResource {
    ...
    @POST
    @Path("")
    public AuditMessage saveAuditMessage(String json) throws Exception {
        try {
            AuditMessage auditMessage = gson.fromJson(json, AuditMessage.class);
            return auditManager.saveAuditMessage(auditMessage);
         } catch (Exception ex) {
