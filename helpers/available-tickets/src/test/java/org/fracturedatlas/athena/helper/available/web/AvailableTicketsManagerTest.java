...
public class AvailableTicketsManagerTest extends BaseManagerTest {
    ...
    AvailableTicketsManager manager = new AvailableTicketsManager();
    ...
    public void testFindAvailableTickets() throws Exception {
        ...
        Set<PTicket> foundTickets = manager.findTickets(TICKET, queryParams);
    ...
    public void createSampleObjects() throws Exception {
        ...
        when(mockRecordManager.findTickets(TICKET, queryParams)).thenReturn(tickets);
    }
}
