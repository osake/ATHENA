    ...
    public void testGetTransaction() throws Exception {
        ...
        for(Ticket t : ticketsToDelete) {
            ...
            if(i<3) {
                ...
                t.addTicketProp(new StringTicketProp(lockedByApiProp, testApiKey));
        ...
        AthenaLock tran = gson.fromJson(tix.path(path).header("X-ATHENA-Key", testApiKey).type("application/json").get(String.class), AthenaLock.class);
        ...
        assertEquals(testApiKey, tran.getLockedByApi());
